 ...
 * 得到的值），这里的的开始时间戳，一般是我们的id生成器开始使用的时间，由我们程序来指定的（如下下面程序IdWorker类的startTime属性）。41位的时间戳，
...
public class SnowflakeIdGenerator {
    ...
    public synchronized long nextId() {
        ...
        // 如果当前时间小于上一次ID生成的时间戳，说明系统时钟回退过这个时候直接抛出异常。
    ...
    public static long genSnowFlakeID() {
        SnowflakeIdGenerator idWorker = new SnowflakeIdGenerator(new Random().nextInt(20) + 1, new Random().nextInt(20) + 1);
    ...
    public static String genSnowFlakeIDStr() {
        return String.valueOf(genSnowFlakeID());
    }
